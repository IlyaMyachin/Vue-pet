      ...
      <section class="item">
        <div class="item__pics pics">
          <div class="pics__wrapper">
            <img width="570" height="570" :src="product.image.file.url" srcset="img/phone-square@2x.jpg 2x"
              :alt="product.title">
          </div>
        </div>
        ...
        <div class="item__info">
          ...
          <div class="item__form">
            <form class="form" action="#" method="POST" @submit.prevent="addToCart">
              ...
              <div class="item__row">
                <CartItemAmount :item-amount.sync="productAmount" />
...
export default {
  ...
  methods: {
    ...
    loadProduct() {
      ...
      this.prodctLoadingFailed = false;
